...
class DeleteProgress extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		OptionsMenu.instance.openSubState(new DeleteSubState());
		return false;
	}
...
class ResultsOption extends Option
{
	public function new(desc:String)
	{
		super();
	...
	public override function press():Bool
	{
		FlxG.save.data.showResults = !FlxG.save.data.showResults;
		display = updateDisplay();
		return true;
	}
	...
	private override function updateDisplay():String
	{
		return "Results Screen " + (FlxG.save.data.showResults ? "On" : "Off");
	}
}