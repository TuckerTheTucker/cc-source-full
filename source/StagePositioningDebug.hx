...
class StagePositioningDebug extends FlxState
{
	...
	override function create()
	{
		...
		FlxG.sound.playMusic(Paths.music('dbugmenu', 'shared'));
		...
		welcomeText = new FlxText(0, 0);
		welcomeText.size = 36;
		welcomeText.scrollFactor.set();
		welcomeText.cameras = [camHUD];
		welcomeText.text = ("Welcome to the Stage Positioning Debug Menu.");
		add(welcomeText);

		posText = new FlxText(0, 42);
		posText.size = 26;
